 ...
 * @author mzechner */
/** @author jshapcot */
public class AppAndroidInput extends AbstractInput implements AndroidInput {
	...
	protected final AppAndroidTouchHandler touchHandler;
	...
	private final AppAndroidMouseHandler mouseHandler;

	public AppAndroidInput(Application activity, Context context, Object view, AndroidApplicationConfiguration config) {
		...
		this.config = config;
		this.mouseHandler = new AppAndroidMouseHandler();
		...
		touchHandler = new AppAndroidTouchHandler();
