...
public  abstract class AppFragment extends Fragment implements AndroidApplicationBase {
...
//	protected AndroidAudio audio;
	...
	public View initializeForView (ApplicationListener listener, AndroidApplicationConfiguration config) {
		...
		graphics = new AndroidGraphicsIm(this, config, config.resolutionStrategy == null ? new FillResolutionStrategy()
...
//		audio = createAudio(getActivity(), config);
		...
		this.clipboard = new AndroidClipboard(getActivity().getApplicationContext());
...
//		});
	...
	public AndroidInput createInput (Application activity, Context context, Object view, AndroidApplicationConfiguration config) {
		if(defaultAndroidInput==null){
			defaultAndroidInput =new AppAndroidInput(this, getActivity().getApplicationContext(), graphics.view, config);
		}
