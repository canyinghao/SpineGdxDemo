...
public class AppAndroidTouchHandler {
	public void onTouch (MotionEvent event, AppAndroidInput input) {
	...
	private void postTouchEvent (AppAndroidInput input, int type, int x, int y, int pointer, int button, long timeStamp) {
